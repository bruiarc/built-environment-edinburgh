...
### An occupancy centric control application for the built environment
- 2026-08: A talk by *** from Hong Kong PolyU.
    > Abstract: ***
### Fit-for-purpose modelling for building retrofit and operation planning: detailed versus lumped-parameter simulations under varying data constraints
...
### A novel data-driven approach for building energy model calibration
